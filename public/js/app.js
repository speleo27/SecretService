...
__webpack_require__(/*! ./plugin/tomSelect */ "./resources/js/plugin/tomSelect.js");
...
/***/ "./resources/js/plugin/tomSelect.js":
/*!******************************************!*\
  !*** ./resources/js/plugin/tomSelect.js ***!
  \******************************************/
...
var tsTarget = new (tom_select__WEBPACK_IMPORTED_MODULE_0___default())("#target", configTarget);
var configTarget = {
...
var tsContact = new (tom_select__WEBPACK_IMPORTED_MODULE_0___default())("#contact", configContact);
var configContact = {
  plugins: ['remove_button'],
  render: {},
  sortField: {
