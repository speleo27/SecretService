@extends('layouts.app')
@section("content")
    <h1 class="text-center font-bold text-dark-600 uppercase">Créer un nouveau target</h1>
        ...
        <form class="max-w-5xl mx-auto" method="post">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="text-center">
                    ...
                    <input type="text" class="w-full bg-gray-200 border-solid rounded" name="target_firstname"/>
                </div>
                <div class=" text-center">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2 " for="grid-last-name">
                        Noms
                    </label>
                    <input type="text" class="w-full bg-gray-200 border-solid rounded" name="target_lastname"/>
                </div>
                ...
                <div class=" text-center">
                    ...
                    <input type="date" class="w-full bg-gray-200 border-solid rounded" name="target_birthday"/>
                </div>
                <div class=" text-center">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                        Pseudo
                    </label>
                    <input type="text" class="w-full bg-gray-200 border-solid rounded" name="target_pseudo"/>
                </div>
