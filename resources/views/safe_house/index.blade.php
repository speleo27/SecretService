...
@section("content")
    ...
    <div class="container">
        <a href="{{route("safe_house.create")}}" class="bg-blue-600 text-center text-white px-3 py-3 border-solid rounded">Ajouter une planque</a>
    </div>
                ...
                <table class="w-full" id="agents">
                    ...
                    @foreach($safeHouse as $safe)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 border text-center">{{$safe->safeHouse_city}}</td>
                            <td class="px-4 py-3 border text-center">{{$safe->country->country_name}}</td>
                            <td class="px-4 py-3 border text-center">{{$safe->type->safe_house_type_name}}</td>
